export function RoutesConfig($stateProvider, $urlRouterProvider) {
    ...
    $stateProvider
        ...
        .state('app.topicsection', {
            ...
            views: {
                'main@app': {
                    template: '<topic-section></topic-section>'
                }
            }
        })
        .state('app.statesection', {
            url: '/states-section',
            data: {
                auth: true
            },
            views: {
                'main@app': {
                    template: '<state-section></state-section>'
                }
            }
        })
        .state('app.topicsadd', {
            ...
            views: {
                'main@app': {
                    template: '<topics-add></topics-add>'
                }
            },
            params: {
                alerts: null
        ...
        .state('app.assessmentadd', {
            url: '/quarterly-assessment-add',
            data: {
                auth: true
            },
            views: {
                'main@app': {
                    template: '<assessment-add></assessment-add>'
                }
            },
            params: {
                alerts: null
        ...
        .state('app.assessmentedit', {
            url: '/quarterly-assessment-edit/:assessmentId',
            data: {
                auth: true
            },
            views: {
                'main@app': {
                    template: '<assessment-edit></assessment-edit>'
                }
            },
            params: {
                alerts: null,
        ...
        .state('app.captureadd', {
            ...
            views: {
                'main@app': {
                    template: '<capture-add></capture-add>'
                }
            },
            params: {
                alerts: null
        ...
        .state('app.captureedit', {
            url: '/capture-edit/:dataId',
            data: {
                auth: true
            },
            views: {
                'main@app': {
                    template: '<capture-edit></capture-edit>'
                }
            },
            params: {
                alerts: null,
        ...
        .state('app.partnersadd', {
            ...
            views: {
                'main@app': {
                    template: '<partner-add></partner-add>'
                }
            },
            params: {
                alerts: null
        ...
        .state('app.partnersedit', {
            url: '/partners-edit/:partnerId',
            data: {
                auth: true
            },
            views: {
                'main@app': {
                    template: '<partner-edit></partner-edit>'
                }
            },
            params: {
                alerts: null,
        ...
        .state('app.keyfields', {
            ...
            views: {
                'main@app': {
                    template: '<key-fields></key-fields>'
                }
            }
        })
        .state('app.keyfieldadd', {
            url: '/key-fields-add',
            data: {
                auth: true
            },
            views: {
                'main@app': {
                    template: '<key-field-add></key-field-add>'
                }
            },
            params: {
                alerts: null
        ...
        .state('app.keyfieldedit', {
            url: '/key-field-edit/:keyFieldId',
            data: {
                auth: true
            },
            views: {
                'main@app': {
                    template: '<key-field-edit></key-field-edit>'
                }
            },
            params: {
                alerts: null,
