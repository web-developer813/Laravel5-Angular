...
$api->group(['middleware' => ['api', 'api.auth']], function ($api) {
    ...
    $api->controller('topics', 'TopicController');
    $api->controller('keyFields', 'KeyFieldController');
    $api->controller('states', 'StateController');
    $api->controller('datas', 'DailyController');
    $api->controller('assessments', 'AssessmentController');
    $api->controller('quarters', 'QuarterController');
    $api->controller('partners', 'PartnerController');
});

$api->group(['middleware' => ['api', 'api.auth', 'role:master.admin']], function ($api) {
