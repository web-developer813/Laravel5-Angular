...
elixir(function (mix) {
  ...
  mix.copy("./bower_components/angularjs-dropdown-multiselect/**", "public/js/angularjs-dropdown-multiselect");
  mix.copy("./bower_components/lodash/**", "public/js/lodash");
  mix.copy("./bower_components/angular-ui-select/**", "public/js/angular-ui-select");
  mix.copy("./bower_components/angular-sanitize/**", "public/js/angular-sanitize");
